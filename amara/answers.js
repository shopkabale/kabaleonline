export const answers = {
  ...
  "prompt_upload_conversation": { text: "I can help with that. Should I guide you through creating the listing step-by-step in this conversation?", suggestions: ["Yes, guide me", "No, just give instructions"] },
  "upload_flow": {
  ...
  "user_not_logged_in": { text: "You need to be logged in to do that. Please <a href='/login/'>log in</a> or <a href='/signup/'>create an account</a> first.", suggestions: ["How to sell", "How to buy"] },
  ...
  "signup": { text: "I can help with that! To keep your information safe, the best way to create an account is on our secure signup page. <a href=\"/signup/\" target=\"_blank\">Click here to get started.</a>" },
  "login_flow": {
    "start": { text: "I can help with that. What is the email address you used to sign up?", suggestions: ["Cancel"] },
    "finish": { text: "Perfect! I've sent a secure login link to that email address. Please check your inbox (and spam folder) and click the link to sign in." }
  },
  "mark_as_sold_flow": {
      "start": { text: "Okay, I can help mark an item as sold. To find the right one, what is the exact title of the product you sold?", suggestions: ["Cancel"] }
  },
  "greetings": [
  ...
  "chitchat_weather": [ { text: "I don't have windows, but my forecast says it's a 100% chance of finding great deals on KabaleOnline! ☀️", suggestions: ["Find me a deal", "Help"] } ],
  ...
  "delivery_options": { text: `🚴‍♂️ Currently, all deliveries are arranged directly between the buyer and seller. We recommend agreeing on a safe, public place to meet for the exchange. A trusted Boda Boda can also be used for small items once payment is confirmed.`, suggestions: ["Safety tips", "What payment methods are used?"] },
