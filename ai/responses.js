// File: /ai/responses.js (The Definitive, Complete & Expanded Version)

/**
 * =======================================================================================
 * AMARA AI INTENT DICTIONARY
 * =======================================================================================
 * This file acts as Amara's "ears." It maps various user phrases to a single, specific intent.
 * The more keywords you add here, the more flexible Amara's understanding becomes.
 * The keys here (e.g., "sell") must match the keys in the answers.js knowledge base.
 * =======================================================================================
 */
...
const responses = {
  ...
  // These are the primary triggers for searching items on the platform.
  // =======================================================================================
  ...
  // These intents correspond to the main functions of the KabaleOnline platform.
  // =======================================================================================

  "sell": ["how do i sell", "guide to selling", "how can i sell", "how to sell", "sell an item", "post an item", "listing", "advertise", "place ad", "post an ad", "list an item", "put up for sale"],
  ...
  "start_upload": ["i want to sell", "i would like to sell", "sell my phone", "sell my laptop", "post an item for sale", "create a listing", "upload an item", "how to upload an item", "list my item"],
  ...
  // Phrases related to managing a user's account and their listings.
  // =======================================================================================

  "go_to_dashboard": ["go to my dashboard", "my dashboard", "show me my dashboard", "open dashboard", "my account", "my listings", "manage my items", "my products", "my posts"],
  ...
  // =======================================================================================
  // SAFETY, SUPPORT & TROUBLESHOOTING
  // Keywords for when a user needs help, has a problem, or is concerned about safety.
  // =======================================================================================

  "user_safety": ["safe", "safety", "secure", "scam", "fraud", "is it safe", "how to buy safely", "how to sell safely", "avoid scams", "report scam", "safety tips", "is this user safe", "how to avoid fraud"],
  "contact": ["admin", "contact", "support", "problem", "issue", "report", "sensitive", "manager", "stuck", "bug", "talk to a person", "customer support", "report a user", "need human help", "contact admin"],
  ...
  // =======================================================================================
  // TRANSACTION & SELLING DETAILS
  // Specific questions about the process of buying and selling.
  // =======================================================================================
  ...
  // Questions about KabaleOnline as an organization.
  // =======================================================================================
  ...
  // Keywords related to specific pages or features of the site.
  // =======================================================================================
  ...
  // =======================================================================================
  // GENERAL CHITCHAT
  // Common conversational phrases to make Amara feel more natural.
  // =======================================================================================
  ...
  // Simple words that control the direction of the conversation.
  // =======================================================================================

  "gratitude": ["thanks", "thank you", "ok thanks", "nice", "great", "awesome", "cool", "thank u", "much appreciated", "thanks a lot", "i appreciate it"],
  "affirmation": ["yes", "yep", "yeah", "sure", "ok", "okay", "correct", "of course", "y", "affirmative", "absolutely", "exactly", "deal", "do it", "please do"],
