const responses = {
  ...
  // ============================================================
  // --- 1. CORE ACTIONS & CONVERSATIONAL FLOW ---
  // High-priority actions and basic conversational keywords.
  // ============================================================
  ...
  // ============================================================
  // --- 2. LIVE LOOKUPS & UTILITY FEATURES ---
  // Triggers for API calls (Algolia) or internal calculations.
  // ============================================================
  ...
  // ============================================================
  // --- 3. ACCOUNT & LISTING MANAGEMENT ---
  // Keywords for users managing their listings and account.
  // ============================================================
  ...
  // ============================================================
  // --- 4. PLATFORM INFORMATION & KNOWLEDGE BASE ---
  // Keywords for questions about how the platform works.
  // ============================================================
  ...
  "objectives": ["what are your objectives", "your objectives", "objectives", "goals", "aims" , "platform objectives", "what is your main goal"],
  ...
  // ============================================================
  // --- 5. CHITCHAT & PERSONALITY ---
  // Keywords for non-transactional, friendly conversation.
  // ============================================================
  ...
  // ============================================================
  // --- 6. CATEGORY TRIGGERS ---
  // Specific keywords that map directly to product categories.
  // ============================================================
